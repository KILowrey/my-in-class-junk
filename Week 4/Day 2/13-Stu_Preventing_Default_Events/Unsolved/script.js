...
var totalEl = dcument.querySelector("#total");
...
function calculateTotal(total, tipAmout) {
    return parseFloat(total) + parseFloat(tipAmout);
}
...
// add splitEl.addEventListener here